...
Энэ шатанд товчоор ажиллуулах урсгал хэвээр; автомат worker, retry scheduler,
таталтын offset хадгалалт нэмээгүй.
Процесс гэнэт тасарвал `pending`/`processing` мөрүүд хадгалагдан үлдэнэ.
Автоматаар сэргээх ажиллагаа одоогоор байхгүй; `processing` мөрийг дахин ажиллуулахын
өмнө өмнөх процесс зогссоныг баталгаажуулж төлөвийг сэргээх шаардлагатай.
...
API нь session хамгаалалттай, танилтын моделийг дуудахгүй. Frontend дээр өмнөх/дараах
хуудас, шинэчлэх товчтой; шинэ batch дуусахад эхний хуудсыг дахин уншина.
